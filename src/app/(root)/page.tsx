    ...
    return (
        <div className=" z-20 flex flex-col items-center justify-start min-h-screen py-2 mt-10">
            <div className="flex flex-col justify-center items-center my-5">
                ...
                <h1 className=" z-20 text-6xl mt-5 font-extrabold text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-500 via-purple-500 to-pink-500 dark:from-purple-400 dark:via-purple-400 dark:to-purple-400 tracking-tighter leading-[1.3] ">
